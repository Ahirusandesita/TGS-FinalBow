...
public class ArrowEnchantUI : MonoBehaviour
{
    ...
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[1].UIImage);
    }
    public void ArrowEnchantUI_Thunder()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[2].UIImage);
    }
    public void ArrowEnchantUI_KnockBack()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[3].UIImage);
    }
    public void ArrowEnchantUI_Homing()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[4].UIImage);
    }
    public void ArrowEnchantUI_Penetrate()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[5].UIImage);
    }
    public void ArrowEnchantUI_BombThunder()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[1].UIImage);
        _enchantUIManager.EnchantImage2Chenge(_EnchantUI._enchantUIs[2].UIImage);
    }
    public void ArrowEnchantUI_BombKnockBack()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[1].UIImage);
        _enchantUIManager.EnchantImage2Chenge(_EnchantUI._enchantUIs[3].UIImage);
    }
    public void ArrowEnchantUI_BombHoming()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[1].UIImage);
        _enchantUIManager.EnchantImage2Chenge(_EnchantUI._enchantUIs[4].UIImage);
    }
    public void ArrowEnchantUI_BombPenetrate()
    {
        _enchantUIManager.EnchantImageReset();
        _enchantUIManager.EnchantImage1Chenge(_EnchantUI._enchantUIs[1].UIImage);
        _enchantUIManager.EnchantImage2Chenge(_EnchantUI._enchantUIs[5].UIImage);
    }
