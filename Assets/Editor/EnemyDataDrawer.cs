        ...
        using (new EditorGUI.PropertyScope(position, label, property))
        {
            ...
            switch ((BirdAttackType)attackTypeProperty2.enumValueIndex)
            {
                case BirdAttackType.none:
                    ...
                    directionStopProperty.enumValueIndex = EditorGUI.Popup(directionRect, "停止中の向き", directionStopProperty.enumValueIndex, Enum.GetNames(typeof(DirectionType_AtStopping)));
                ...
                default:
                    ...
                    directionAttackProperty.enumValueIndex = EditorGUI.Popup(directionRect, "攻撃の向き", directionAttackProperty.enumValueIndex, Enum.GetNames(typeof(DirectionType_AtAttack)));
